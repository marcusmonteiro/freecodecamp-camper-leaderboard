...
view model =
    div [class "container-fluid"]
        [ div [class "row center-block", style [("max-width", "67%")]]
              [ div [class "panel panel-default"]
                    [ div [class "panel-heading text-center"] [text "FreeCodeCamp Top 100 Leaderboard"]
                    , div [class "panel-body text-center"] [text "Click the buttons to order by recent or by all time points"]
